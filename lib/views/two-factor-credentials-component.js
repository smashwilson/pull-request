...
export default class TwoFactorCredentialsComponent {
  ...
  constructor({twoFactorCredentials}) {
    ...
    this.subs.add(this.listener.add('.btn.verify', 'click', this.handleVerify.bind(this)));
    this.subs.add(this.listener.add('input.code', 'input', this.handleType.bind(this)));

    this.subs.add(this.two.onDidReportError(() => etch.updateElement(this)));
  }
